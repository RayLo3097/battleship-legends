            ...
            if (lobbyCode != null) {
                ...
                if (player != null && playerWhoShot != null) {
                    ...
                    if (!"Default".equals(selectedPowerUp)) {
                        // Call the respective power-up function based on the selected power-up
                        switch (selectedPowerUp) {
//                            case "Radar":
                                //player.getGameBoard().radarPowerUp(jsonNode.get("row").asInt(), jsonNode.get("col").asInt());
//                                break;
                            case "Bomb":
                            ...
                            case "Nuke":
                                ...
                                break;
//                            case "Decoy":
//                                //player.getGameBoard().decoyPowerUp(jsonNode.get("row").asInt(), jsonNode.get("col").asInt());
//                                break;
                            default:
